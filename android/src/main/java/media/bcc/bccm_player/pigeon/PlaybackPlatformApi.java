...
public class PlaybackPlatformApi {
  ...
  public static final class AppConfig {
    ...
    static @NonNull AppConfig fromList(@NonNull ArrayList<Object> __pigeon_list) {
      AppConfig pigeonResult = new AppConfig();
      Object appLanguage = __pigeon_list.get(0);
      pigeonResult.setAppLanguage((String) appLanguage);
      Object audioLanguages = __pigeon_list.get(1);
      pigeonResult.setAudioLanguages((List<String>) audioLanguages);
      Object subtitleLanguages = __pigeon_list.get(2);
      pigeonResult.setSubtitleLanguages((List<String>) subtitleLanguages);
      Object analyticsId = __pigeon_list.get(3);
      pigeonResult.setAnalyticsId((String) analyticsId);
      Object sessionId = __pigeon_list.get(4);
  ...
  public static final class MediaItem {
    ...
    static @NonNull MediaItem fromList(@NonNull ArrayList<Object> __pigeon_list) {
      ...
      Object isLive = __pigeon_list.get(3);
      pigeonResult.setIsLive((Boolean) isLive);
      Object isOffline = __pigeon_list.get(4);
      pigeonResult.setIsOffline((Boolean) isOffline);
      Object playbackStartPositionMs = __pigeon_list.get(5);
      pigeonResult.setPlaybackStartPositionMs((Double) playbackStartPositionMs);
      Object lastKnownAudioLanguage = __pigeon_list.get(6);
      pigeonResult.setLastKnownAudioLanguage((String) lastKnownAudioLanguage);
      Object lastKnownSubtitleLanguage = __pigeon_list.get(7);
  ...
  public static final class MediaMetadata {
    ...
    static @NonNull MediaMetadata fromList(@NonNull ArrayList<Object> __pigeon_list) {
      MediaMetadata pigeonResult = new MediaMetadata();
      Object artworkUri = __pigeon_list.get(0);
      pigeonResult.setArtworkUri((String) artworkUri);
      Object title = __pigeon_list.get(1);
      pigeonResult.setTitle((String) title);
      Object artist = __pigeon_list.get(2);
      pigeonResult.setArtist((String) artist);
      Object durationMs = __pigeon_list.get(3);
      pigeonResult.setDurationMs((Double) durationMs);
      Object extras = __pigeon_list.get(4);
  ...
  public static final class PlayerError {
    ...
    static @NonNull PlayerError fromList(@NonNull ArrayList<Object> __pigeon_list) {
      PlayerError pigeonResult = new PlayerError();
      Object code = __pigeon_list.get(0);
  ...
  public static final class VideoSize {
    ...
    static @NonNull VideoSize fromList(@NonNull ArrayList<Object> __pigeon_list) {
  ...
  public static final class ChromecastState {
    ...
    static @NonNull ChromecastState fromList(@NonNull ArrayList<Object> __pigeon_list) {
      ChromecastState pigeonResult = new ChromecastState();
      Object connectionState = __pigeon_list.get(0);
      pigeonResult.setConnectionState((CastConnectionState) connectionState);
      Object mediaItem = __pigeon_list.get(1);
  ...
  public static final class MediaInfo {
    ...
    static @NonNull MediaInfo fromList(@NonNull ArrayList<Object> __pigeon_list) {
      MediaInfo pigeonResult = new MediaInfo();
      Object audioTracks = __pigeon_list.get(0);
      pigeonResult.setAudioTracks((List<Track>) audioTracks);
      Object textTracks = __pigeon_list.get(1);
      pigeonResult.setTextTracks((List<Track>) textTracks);
      Object videoTracks = __pigeon_list.get(2);
  ...
  public static final class PlayerTracksSnapshot {
    ...
    static @NonNull PlayerTracksSnapshot fromList(@NonNull ArrayList<Object> __pigeon_list) {
      PlayerTracksSnapshot pigeonResult = new PlayerTracksSnapshot();
      Object playerId = __pigeon_list.get(0);
      pigeonResult.setPlayerId((String) playerId);
      Object audioTracks = __pigeon_list.get(1);
      pigeonResult.setAudioTracks((List<Track>) audioTracks);
      Object textTracks = __pigeon_list.get(2);
      pigeonResult.setTextTracks((List<Track>) textTracks);
      Object videoTracks = __pigeon_list.get(3);
      pigeonResult.setVideoTracks((List<Track>) videoTracks);
      return pigeonResult;
    }
  }
  ...
  public static final class Track {
    ...
    static @NonNull Track fromList(@NonNull ArrayList<Object> __pigeon_list) {
      Track pigeonResult = new Track();
      Object id = __pigeon_list.get(0);
      pigeonResult.setId((String) id);
      Object label = __pigeon_list.get(1);
      pigeonResult.setLabel((String) label);
      Object language = __pigeon_list.get(2);
      pigeonResult.setLanguage((String) language);
      Object frameRate = __pigeon_list.get(3);
      pigeonResult.setFrameRate((Double) frameRate);
      Object bitrate = __pigeon_list.get(4);
      pigeonResult.setBitrate((bitrate == null) ? null : ((bitrate instanceof Integer) ? (Integer) bitrate : (Long) bitrate));
      Object width = __pigeon_list.get(5);
      pigeonResult.setWidth((width == null) ? null : ((width instanceof Integer) ? (Integer) width : (Long) width));
      Object height = __pigeon_list.get(6);
      pigeonResult.setHeight((height == null) ? null : ((height instanceof Integer) ? (Integer) height : (Long) height));
      Object downloaded = __pigeon_list.get(7);
      pigeonResult.setDownloaded((Boolean) downloaded);
      Object isSelected = __pigeon_list.get(8);
  ...
  public static final class PrimaryPlayerChangedEvent {
    ...
    static @NonNull PrimaryPlayerChangedEvent fromList(@NonNull ArrayList<Object> __pigeon_list) {
  ...
  public static final class PlayerStateUpdateEvent {
    ...
    static @NonNull PlayerStateUpdateEvent fromList(@NonNull ArrayList<Object> __pigeon_list) {
  ...
  public static final class PositionDiscontinuityEvent {
    ...
    static @NonNull PositionDiscontinuityEvent fromList(@NonNull ArrayList<Object> __pigeon_list) {
      PositionDiscontinuityEvent pigeonResult = new PositionDiscontinuityEvent();
      Object playerId = __pigeon_list.get(0);
      pigeonResult.setPlayerId((String) playerId);
      Object playbackPositionMs = __pigeon_list.get(1);
      pigeonResult.setPlaybackPositionMs((Double) playbackPositionMs);
      return pigeonResult;
    }
  }
  ...
  public static final class PlaybackStateChangedEvent {
    ...
    static @NonNull PlaybackStateChangedEvent fromList(@NonNull ArrayList<Object> __pigeon_list) {
  ...
  public static final class PlaybackEndedEvent {
    ...
    static @NonNull PlaybackEndedEvent fromList(@NonNull ArrayList<Object> __pigeon_list) {
  ...
  public static final class PictureInPictureModeChangedEvent {
    ...
    static @NonNull PictureInPictureModeChangedEvent fromList(@NonNull ArrayList<Object> __pigeon_list) {
      PictureInPictureModeChangedEvent pigeonResult = new PictureInPictureModeChangedEvent();
      Object playerId = __pigeon_list.get(0);
      pigeonResult.setPlayerId((String) playerId);
      Object isInPipMode = __pigeon_list.get(1);
  ...
  public static final class MediaItemTransitionEvent {
    ...
    static @NonNull MediaItemTransitionEvent fromList(@NonNull ArrayList<Object> __pigeon_list) {
  ...
  private static class PigeonCodec extends StandardMessageCodec {
    ...
    protected void writeValue(@NonNull ByteArrayOutputStream stream, Object value) {
      ...
      } else if (value instanceof BufferMode) {
        stream.write(147);
  ...
  public interface PlaybackPlatformPigeon {
    ...
    static void setUp(@NonNull BinaryMessenger binaryMessenger, @NonNull String messageChannelSuffix, @Nullable PlaybackPlatformPigeon api) {
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.bccm_player.PlaybackPlatformPigeon.queueMediaItem" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<Object>();
