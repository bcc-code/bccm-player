...
public class DownloaderApi {
  ...
  public static final class DownloadConfig {
    ...
    static @NonNull DownloadConfig fromList(@NonNull ArrayList<Object> __pigeon_list) {
      DownloadConfig pigeonResult = new DownloadConfig();
      Object url = __pigeon_list.get(0);
      pigeonResult.setUrl((String) url);
      Object mimeType = __pigeon_list.get(1);
      pigeonResult.setMimeType((String) mimeType);
      Object title = __pigeon_list.get(2);
      pigeonResult.setTitle((String) title);
      Object audioTrackIds = __pigeon_list.get(3);
      pigeonResult.setAudioTrackIds((List<String>) audioTrackIds);
      Object videoTrackIds = __pigeon_list.get(4);
      pigeonResult.setVideoTrackIds((List<String>) videoTrackIds);
      Object additionalData = __pigeon_list.get(5);
  ...
  public static final class Download {
    ...
    static @NonNull Download fromList(@NonNull ArrayList<Object> __pigeon_list) {
      Download pigeonResult = new Download();
      Object key = __pigeon_list.get(0);
      pigeonResult.setKey((String) key);
      Object config = __pigeon_list.get(1);
      pigeonResult.setConfig((DownloadConfig) config);
      Object offlineUrl = __pigeon_list.get(2);
      pigeonResult.setOfflineUrl((String) offlineUrl);
      Object fractionDownloaded = __pigeon_list.get(3);
      pigeonResult.setFractionDownloaded((Double) fractionDownloaded);
      Object status = __pigeon_list.get(4);
      pigeonResult.setStatus((DownloadStatus) status);
      Object error = __pigeon_list.get(5);
  ...
  public static final class DownloadFailedEvent {
    ...
    static @NonNull DownloadFailedEvent fromList(@NonNull ArrayList<Object> __pigeon_list) {
      DownloadFailedEvent pigeonResult = new DownloadFailedEvent();
      Object key = __pigeon_list.get(0);
      pigeonResult.setKey((String) key);
      Object error = __pigeon_list.get(1);
      pigeonResult.setError((String) error);
      return pigeonResult;
    }
  }
  ...
  public static final class DownloadRemovedEvent {
    ...
    static @NonNull DownloadRemovedEvent fromList(@NonNull ArrayList<Object> __pigeon_list) {
  ...
  public static final class DownloadChangedEvent {
    ...
    static @NonNull DownloadChangedEvent fromList(@NonNull ArrayList<Object> __pigeon_list) {
      DownloadChangedEvent pigeonResult = new DownloadChangedEvent();
      Object download = __pigeon_list.get(0);
  ...
  private static class PigeonCodec extends StandardMessageCodec {
    ...
    protected Object readValueOfType(byte type, @NonNull ByteBuffer buffer) {
      switch (type) {
        ...
        case (byte) 134:
          ...
          return value == null ? null : DownloadStatus.values()[(int) value];
        default:
    ...
    protected void writeValue(@NonNull ByteArrayOutputStream stream, Object value) {
      if (value instanceof DownloadConfig) {
        stream.write(129);
      ...
      } else if (value instanceof DownloadStatus) {
        stream.write(134);
