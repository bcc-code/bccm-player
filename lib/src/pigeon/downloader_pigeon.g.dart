...
class DownloaderPigeon {
  ...
  Future<Download> startDownload(DownloadConfig downloadConfig) async {
    final String __pigeon_channelName = 'dev.flutter.pigeon.bccm_player.DownloaderPigeon.startDownload$__pigeon_messageChannelSuffix';
    ...
    final List<Object?>? __pigeon_replyList =
        await __pigeon_channel.send(<Object?>[downloadConfig]) as List<Object?>?;
    if (__pigeon_replyList == null) {
      ...
      return (__pigeon_replyList[0] as Download?)!;
    }
  }

  Future<double> getDownloadStatus(String downloadKey) async {
    final String __pigeon_channelName = 'dev.flutter.pigeon.bccm_player.DownloaderPigeon.getDownloadStatus$__pigeon_messageChannelSuffix';
    final BasicMessageChannel<Object?> __pigeon_channel = BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
      binaryMessenger: __pigeon_binaryMessenger,
    ...
    final List<Object?>? __pigeon_replyList =
        await __pigeon_channel.send(<Object?>[downloadKey]) as List<Object?>?;
    if (__pigeon_replyList == null) {
      throw _createConnectionError(__pigeon_channelName);
    } else if (__pigeon_replyList.length > 1) {
      throw PlatformException(
  ...
  Future<List<Download?>> getDownloads() async {
    final String __pigeon_channelName = 'dev.flutter.pigeon.bccm_player.DownloaderPigeon.getDownloads$__pigeon_messageChannelSuffix';
    final BasicMessageChannel<Object?> __pigeon_channel = BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
      binaryMessenger: __pigeon_binaryMessenger,
    ...
    if (__pigeon_replyList == null) {
      ...
      return (__pigeon_replyList[0] as List<Object?>?)!.cast<Download?>();
    }
  }

  Future<Download?> getDownload(String downloadKey) async {
    final String __pigeon_channelName = 'dev.flutter.pigeon.bccm_player.DownloaderPigeon.getDownload$__pigeon_messageChannelSuffix';
    final BasicMessageChannel<Object?> __pigeon_channel = BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
      binaryMessenger: __pigeon_binaryMessenger,
  ...
  Future<void> removeDownload(String downloadKey) async {
    final String __pigeon_channelName = 'dev.flutter.pigeon.bccm_player.DownloaderPigeon.removeDownload$__pigeon_messageChannelSuffix';
    final BasicMessageChannel<Object?> __pigeon_channel = BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
      binaryMessenger: __pigeon_binaryMessenger,
  ...
  Future<double> getFreeDiskSpace() async {
    final String __pigeon_channelName = 'dev.flutter.pigeon.bccm_player.DownloaderPigeon.getFreeDiskSpace$__pigeon_messageChannelSuffix';
    final BasicMessageChannel<Object?> __pigeon_channel = BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
      binaryMessenger: __pigeon_binaryMessenger,
