...
struct DownloadConfig {
  ...
  static func fromList(_ __pigeon_list: [Any?]) -> DownloadConfig? {
    let url = __pigeon_list[0] as! String
    let mimeType = __pigeon_list[1] as! String
    let title = __pigeon_list[2] as! String
    let audioTrackIds = __pigeon_list[3] as! [String?]
    let videoTrackIds = __pigeon_list[4] as! [String?]
    let additionalData = __pigeon_list[5] as! [String?: String?]
...
struct Download {
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ __pigeon_list: [Any?]) -> Download? {
    let key = __pigeon_list[0] as! String
    let config = __pigeon_list[1] as! DownloadConfig
    let offlineUrl: String? = nilOrValue(__pigeon_list[2])
    let fractionDownloaded = __pigeon_list[3] as! Double
    let status = __pigeon_list[4] as! DownloadStatus
    let error: String? = nilOrValue(__pigeon_list[5])
...
struct DownloadFailedEvent {
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ __pigeon_list: [Any?]) -> DownloadFailedEvent? {
    let key = __pigeon_list[0] as! String
...
struct DownloadRemovedEvent {
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ __pigeon_list: [Any?]) -> DownloadRemovedEvent? {
    let key = __pigeon_list[0] as! String
...
struct DownloadChangedEvent {
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ __pigeon_list: [Any?]) -> DownloadChangedEvent? {
    let download = __pigeon_list[0] as! Download
...
private class DownloaderApiPigeonCodecReader: FlutterStandardReader {
  override func readValue(ofType type: UInt8) -> Any? {
    ...
    case 134:
      var enumResult: DownloadStatus? = nil
      let enumResultAsInt: Int? = nilOrValue(self.readValue() as? Int)
      if let enumResultAsInt = enumResultAsInt {
        enumResult = DownloadStatus(rawValue: enumResultAsInt)
      }
      return enumResult
    default:
...
private class DownloaderApiPigeonCodecWriter: FlutterStandardWriter {
  override func writeValue(_ value: Any) {
    if let value = value as? DownloadConfig {
      super.writeByte(129)
