...
+ (DrmConfiguration *)fromList:(NSArray<id> *)list;
+ (nullable DrmConfiguration *)nullableFromList:(NSArray<id> *)list;
- (NSArray<id> *)toList;
@end

@interface CastMedia ()
+ (CastMedia *)fromList:(NSArray<id> *)list;
+ (nullable CastMedia *)nullableFromList:(NSArray<id> *)list;
- (NSArray<id> *)toList;
@end
...
@implementation DrmConfiguration
+ (instancetype)makeWithDrmType:(DrmType)drmType
  ...
  DrmConfiguration* pigeonResult = [[DrmConfiguration alloc] init];
  pigeonResult.drmType = drmType;
  pigeonResult.contentKeyId = contentKeyId;
  pigeonResult.fpsCertificateUrl = fpsCertificateUrl;
  pigeonResult.licenseServerUrl = licenseServerUrl;
  pigeonResult.licenseRequestHeaders = licenseRequestHeaders;
  return pigeonResult;
}
+ (DrmConfiguration *)fromList:(NSArray<id> *)list {
  DrmConfiguration *pigeonResult = [[DrmConfiguration alloc] init];
  DrmTypeBox *boxedDrmType = GetNullableObjectAtIndex(list, 0);
  pigeonResult.drmType = boxedDrmType.value;
  pigeonResult.contentKeyId = GetNullableObjectAtIndex(list, 1);
  pigeonResult.fpsCertificateUrl = GetNullableObjectAtIndex(list, 2);
  pigeonResult.licenseServerUrl = GetNullableObjectAtIndex(list, 3);
  pigeonResult.licenseRequestHeaders = GetNullableObjectAtIndex(list, 4);
  return pigeonResult;
}
+ (nullable DrmConfiguration *)nullableFromList:(NSArray<id> *)list {
  return (list) ? [DrmConfiguration fromList:list] : nil;
}
- (NSArray<id> *)toList {
  return @[
    [[DrmTypeBox alloc] initWithValue:self.drmType],
    self.contentKeyId ?: [NSNull null],
    self.fpsCertificateUrl ?: [NSNull null],
    self.licenseServerUrl ?: [NSNull null],
    self.licenseRequestHeaders ?: [NSNull null],
  ];
}
@end

@implementation CastMedia
+ (instancetype)makeWithUrl:(NSString *)url
    customData:(nullable NSDictionary<NSString *, NSString *> *)customData {
  CastMedia* pigeonResult = [[CastMedia alloc] init];
...
+ (CastMedia *)fromList:(NSArray<id> *)list {
  ...
  pigeonResult.customData = GetNullableObjectAtIndex(list, 1);
  return pigeonResult;
}
+ (nullable CastMedia *)nullableFromList:(NSArray<id> *)list {
  return (list) ? [CastMedia fromList:list] : nil;
}
- (NSArray<id> *)toList {
  return @[
...
+ (instancetype)makeWithId:(nullable NSString *)id
  ...
  pigeonResult.drmConfiguration = drmConfiguration;
  pigeonResult.castMedia = castMedia;
  return pigeonResult;
}
+ (MediaItem *)fromList:(NSArray<id> *)list {
  MediaItem *pigeonResult = [[MediaItem alloc] init];
  ...
  pigeonResult.drmConfiguration = GetNullableObjectAtIndex(list, 9);
  pigeonResult.castMedia = GetNullableObjectAtIndex(list, 10);
  return pigeonResult;
}
+ (nullable MediaItem *)nullableFromList:(NSArray<id> *)list {
...
- (NSArray<id> *)toList {
  return @[
    ...
    self.drmConfiguration ?: [NSNull null],
    self.castMedia ?: [NSNull null],
  ];
}
@end
...
- (nullable id)readValueOfType:(UInt8)type {
  switch (type) {
    ...
    case 131: {
      NSNumber *enumAsNumber = [self readValue];
      return enumAsNumber == nil ? nil : [[DrmTypeBox alloc] initWithValue:[enumAsNumber integerValue]];
    }
    case 132: {
      NSNumber *enumAsNumber = [self readValue];
    ...
    case 137: 
      return [DrmConfiguration fromList:[self readValue]];
    case 138: 
      return [CastMedia fromList:[self readValue]];
    case 139: 
...
- (void)writeValue:(id)value {
  if ([value isKindOfClass:[BufferModeBox class]]) {
    ...
    [self writeByte:130];
    [self writeValue:(value == nil ? [NSNull null] : [NSNumber numberWithInteger:box.value])];
  } else if ([value isKindOfClass:[DrmTypeBox class]]) {
    DrmTypeBox *box = (DrmTypeBox *)value;
    [self writeByte:131];
    [self writeValue:(value == nil ? [NSNull null] : [NSNumber numberWithInteger:box.value])];
    ...
    [self writeByte:136];
    [self writeValue:[value toList]];
  } else if ([value isKindOfClass:[DrmConfiguration class]]) {
    [self writeByte:137];
    [self writeValue:[value toList]];
  } else if ([value isKindOfClass:[CastMedia class]]) {
    [self writeByte:138];
    [self writeValue:[value toList]];
