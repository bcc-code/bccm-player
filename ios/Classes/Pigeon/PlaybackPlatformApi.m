...
+ (SetUrlArgs *)fromList:(NSArray<id> *)list;
+ (nullable SetUrlArgs *)nullableFromList:(NSArray<id> *)list;
- (NSArray<id> *)toList;
@end
...
- (BOOL)isEqual:(id)object {
  ...
  NpawConfig *other = (NpawConfig *)object;
  return FLTPigeonDeepEquals(self.appName, other.appName) && FLTPigeonDeepEquals(self.appReleaseVersion, other.appReleaseVersion) && FLTPigeonDeepEquals(self.accountCode, other.accountCode) && FLTPigeonDeepEquals(self.deviceIsAnonymous, other.deviceIsAnonymous);
}

- (NSUInteger)hash {
  NSUInteger result = [self class].hash;
  result = result * 31 + FLTPigeonDeepHash(self.appName);
  result = result * 31 + FLTPigeonDeepHash(self.appReleaseVersion);
  result = result * 31 + FLTPigeonDeepHash(self.accountCode);
  result = result * 31 + FLTPigeonDeepHash(self.deviceIsAnonymous);
  return result;
}
- (NSString *)description {
  return [NSString stringWithFormat:@"NpawConfig(appName: %@, appReleaseVersion: %@, accountCode: %@, deviceIsAnonymous: %@)", self.appName, self.appReleaseVersion, self.accountCode, self.deviceIsAnonymous];
}
@end
...
- (BOOL)isEqual:(id)object {
  ...
  return FLTPigeonDeepEquals(self.appLanguage, other.appLanguage) && FLTPigeonDeepEquals(self.audioLanguages, other.audioLanguages) && FLTPigeonDeepEquals(self.subtitleLanguages, other.subtitleLanguages) && FLTPigeonDeepEquals(self.analyticsId, other.analyticsId) && FLTPigeonDeepEquals(self.sessionId, other.sessionId);
}

- (NSUInteger)hash {
  NSUInteger result = [self class].hash;
  result = result * 31 + FLTPigeonDeepHash(self.appLanguage);
  result = result * 31 + FLTPigeonDeepHash(self.audioLanguages);
  result = result * 31 + FLTPigeonDeepHash(self.subtitleLanguages);
  result = result * 31 + FLTPigeonDeepHash(self.analyticsId);
  result = result * 31 + FLTPigeonDeepHash(self.sessionId);
  return result;
}
- (NSString *)description {
  return [NSString stringWithFormat:@"AppConfig(appLanguage: %@, audioLanguages: %@, subtitleLanguages: %@, analyticsId: %@, sessionId: %@)", self.appLanguage, self.audioLanguages, self.subtitleLanguages, self.analyticsId, self.sessionId];
}
@end
...
- (NSString *)description {
  return [NSString stringWithFormat:@"User(id: %@)", self.id];
}
@end
...
+ (SetUrlArgs *)fromList:(NSArray<id> *)list {
  ...
  pigeonResult.isLive = GetNullableObjectAtIndex(list, 2);
  return pigeonResult;
}
+ (nullable SetUrlArgs *)nullableFromList:(NSArray<id> *)list {
  return (list) ? [SetUrlArgs fromList:list] : nil;
}
- (NSArray<id> *)toList {
  return @[
...
- (BOOL)isEqual:(id)object {
  ...
  SetUrlArgs *other = (SetUrlArgs *)object;
  return FLTPigeonDeepEquals(self.playerId, other.playerId) && FLTPigeonDeepEquals(self.url, other.url) && FLTPigeonDeepEquals(self.isLive, other.isLive);
}

- (NSUInteger)hash {
  NSUInteger result = [self class].hash;
  result = result * 31 + FLTPigeonDeepHash(self.playerId);
  result = result * 31 + FLTPigeonDeepHash(self.url);
  result = result * 31 + FLTPigeonDeepHash(self.isLive);
  return result;
}
- (NSString *)description {
  return [NSString stringWithFormat:@"SetUrlArgs(playerId: %@, url: %@, isLive: %@)", self.playerId, self.url, self.isLive];
}
@end
...
- (NSUInteger)hash {
  ...
  result = result * 31 + FLTPigeonDeepHash(self.id);
  result = result * 31 + FLTPigeonDeepHash(self.url);
  result = result * 31 + FLTPigeonDeepHash(self.mimeType);
  result = result * 31 + FLTPigeonDeepHash(self.metadata);
  result = result * 31 + FLTPigeonDeepHash(self.isLive);
  result = result * 31 + FLTPigeonDeepHash(self.isOffline);
  result = result * 31 + FLTPigeonDeepHash(self.playbackStartPositionMs);
  result = result * 31 + FLTPigeonDeepHash(self.lastKnownAudioLanguage);
...
- (BOOL)isEqual:(id)object {
  ...
  return FLTPigeonDeepEquals(self.artworkUri, other.artworkUri) && FLTPigeonDeepEquals(self.title, other.title) && FLTPigeonDeepEquals(self.artist, other.artist) && FLTPigeonDeepEquals(self.durationMs, other.durationMs) && FLTPigeonDeepEquals(self.extras, other.extras);
}

- (NSUInteger)hash {
  NSUInteger result = [self class].hash;
  result = result * 31 + FLTPigeonDeepHash(self.artworkUri);
  result = result * 31 + FLTPigeonDeepHash(self.title);
  result = result * 31 + FLTPigeonDeepHash(self.artist);
  result = result * 31 + FLTPigeonDeepHash(self.durationMs);
  result = result * 31 + FLTPigeonDeepHash(self.extras);
  return result;
}
- (NSString *)description {
  return [NSString stringWithFormat:@"MediaMetadata(artworkUri: %@, title: %@, artist: %@, durationMs: %@, extras: %@)", self.artworkUri, self.title, self.artist, self.durationMs, self.extras];
}
@end
...
- (BOOL)isEqual:(id)object {
  ...
  PlayerError *other = (PlayerError *)object;
  return FLTPigeonDeepEquals(self.code, other.code) && FLTPigeonDeepEquals(self.message, other.message);
}

- (NSUInteger)hash {
  NSUInteger result = [self class].hash;
  result = result * 31 + FLTPigeonDeepHash(self.code);
  result = result * 31 + FLTPigeonDeepHash(self.message);
  return result;
}
- (NSString *)description {
  return [NSString stringWithFormat:@"PlayerError(code: %@, message: %@)", self.code, self.message];
}
@end
...
- (BOOL)isEqual:(id)object {
  ...
  VideoSize *other = (VideoSize *)object;
...
- (NSString *)description {
  return [NSString stringWithFormat:@"VideoSize(width: %ld, height: %ld)", (long)self.width, (long)self.height];
}
@end
...
- (BOOL)isEqual:(id)object {
  ...
  ChromecastState *other = (ChromecastState *)object;
  return self.connectionState == other.connectionState && FLTPigeonDeepEquals(self.mediaItem, other.mediaItem);
}

- (NSUInteger)hash {
  NSUInteger result = [self class].hash;
  result = result * 31 + @(self.connectionState).hash;
  result = result * 31 + FLTPigeonDeepHash(self.mediaItem);
  return result;
}
- (NSString *)description {
  return [NSString stringWithFormat:@"ChromecastState(connectionState: %ld, mediaItem: %@)", (long)self.connectionState, self.mediaItem];
}
@end
...
- (BOOL)isEqual:(id)object {
  ...
  return FLTPigeonDeepEquals(self.audioTracks, other.audioTracks) && FLTPigeonDeepEquals(self.textTracks, other.textTracks) && FLTPigeonDeepEquals(self.videoTracks, other.videoTracks);
}

- (NSUInteger)hash {
  NSUInteger result = [self class].hash;
  result = result * 31 + FLTPigeonDeepHash(self.audioTracks);
  result = result * 31 + FLTPigeonDeepHash(self.textTracks);
  result = result * 31 + FLTPigeonDeepHash(self.videoTracks);
  return result;
}
- (NSString *)description {
  return [NSString stringWithFormat:@"MediaInfo(audioTracks: %@, textTracks: %@, videoTracks: %@)", self.audioTracks, self.textTracks, self.videoTracks];
}
@end
...
- (BOOL)isEqual:(id)object {
  ...
  PlayerTracksSnapshot *other = (PlayerTracksSnapshot *)object;
  return FLTPigeonDeepEquals(self.playerId, other.playerId) && FLTPigeonDeepEquals(self.audioTracks, other.audioTracks) && FLTPigeonDeepEquals(self.textTracks, other.textTracks) && FLTPigeonDeepEquals(self.videoTracks, other.videoTracks);
}
...
- (NSString *)description {
  return [NSString stringWithFormat:@"PlayerTracksSnapshot(playerId: %@, audioTracks: %@, textTracks: %@, videoTracks: %@)", self.playerId, self.audioTracks, self.textTracks, self.videoTracks];
}
@end
...
- (NSUInteger)hash {
  ...
  result = result * 31 + FLTPigeonDeepHash(self.language);
  ...
  result = result * 31 + FLTPigeonDeepHash(self.downloaded);
  result = result * 31 + @(self.isSelected).hash;
  return result;
}
- (NSString *)description {
  return [NSString stringWithFormat:@"Track(id: %@, label: %@, language: %@, frameRate: %@, bitrate: %@, width: %@, height: %@, downloaded: %@, isSelected: %@)", self.id, self.label, self.language, self.frameRate, self.bitrate, self.width, self.height, self.downloaded, self.isSelected ? @"true" : @"false"];
}
@end
...
- (BOOL)isEqual:(id)object {
  ...
  PrimaryPlayerChangedEvent *other = (PrimaryPlayerChangedEvent *)object;
  return FLTPigeonDeepEquals(self.playerId, other.playerId);
}
...
- (NSString *)description {
  return [NSString stringWithFormat:@"PrimaryPlayerChangedEvent(playerId: %@)", self.playerId];
}
@end
...
- (BOOL)isEqual:(id)object {
  ...
  PlayerStateUpdateEvent *other = (PlayerStateUpdateEvent *)object;
  return FLTPigeonDeepEquals(self.playerId, other.playerId) && FLTPigeonDeepEquals(self.snapshot, other.snapshot);
}

- (NSUInteger)hash {
  NSUInteger result = [self class].hash;
  result = result * 31 + FLTPigeonDeepHash(self.playerId);
  result = result * 31 + FLTPigeonDeepHash(self.snapshot);
  return result;
}
- (NSString *)description {
  return [NSString stringWithFormat:@"PlayerStateUpdateEvent(playerId: %@, snapshot: %@)", self.playerId, self.snapshot];
}
@end
...
- (BOOL)isEqual:(id)object {
  ...
  PositionDiscontinuityEvent *other = (PositionDiscontinuityEvent *)object;
  return FLTPigeonDeepEquals(self.playerId, other.playerId) && FLTPigeonDeepEquals(self.playbackPositionMs, other.playbackPositionMs);
}
...
- (NSString *)description {
  return [NSString stringWithFormat:@"PositionDiscontinuityEvent(playerId: %@, playbackPositionMs: %@)", self.playerId, self.playbackPositionMs];
}
@end
...
- (BOOL)isEqual:(id)object {
  ...
  PlaybackStateChangedEvent *other = (PlaybackStateChangedEvent *)object;
  return FLTPigeonDeepEquals(self.playerId, other.playerId) && self.playbackState == other.playbackState && self.isBuffering == other.isBuffering;
}
...
- (NSString *)description {
  return [NSString stringWithFormat:@"PlaybackStateChangedEvent(playerId: %@, playbackState: %ld, isBuffering: %@)", self.playerId, (long)self.playbackState, self.isBuffering ? @"true" : @"false"];
}
@end
...
- (BOOL)isEqual:(id)object {
  ...
  PlaybackEndedEvent *other = (PlaybackEndedEvent *)object;
  return FLTPigeonDeepEquals(self.playerId, other.playerId) && FLTPigeonDeepEquals(self.mediaItem, other.mediaItem);
}
...
- (NSString *)description {
  return [NSString stringWithFormat:@"PlaybackEndedEvent(playerId: %@, mediaItem: %@)", self.playerId, self.mediaItem];
}
@end
...
- (BOOL)isEqual:(id)object {
  ...
  PictureInPictureModeChangedEvent *other = (PictureInPictureModeChangedEvent *)object;
  return FLTPigeonDeepEquals(self.playerId, other.playerId) && self.isInPipMode == other.isInPipMode;
}

- (NSUInteger)hash {
  NSUInteger result = [self class].hash;
  result = result * 31 + FLTPigeonDeepHash(self.playerId);
  result = result * 31 + @(self.isInPipMode).hash;
  return result;
}
- (NSString *)description {
  return [NSString stringWithFormat:@"PictureInPictureModeChangedEvent(playerId: %@, isInPipMode: %@)", self.playerId, self.isInPipMode ? @"true" : @"false"];
}
@end
...
- (BOOL)isEqual:(id)object {
  ...
  MediaItemTransitionEvent *other = (MediaItemTransitionEvent *)object;
  return FLTPigeonDeepEquals(self.playerId, other.playerId) && FLTPigeonDeepEquals(self.mediaItem, other.mediaItem);
}
...
- (NSString *)description {
  return [NSString stringWithFormat:@"MediaItemTransitionEvent(playerId: %@, mediaItem: %@)", self.playerId, self.mediaItem];
}
@end
...
- (nullable id)readValueOfType:(UInt8)type {
  switch (type) {
    ...
    case 137: 
      return [SetUrlArgs fromList:[self readValue]];
    case 138: 
...
- (void)writeValue:(id)value {
  if ([value isKindOfClass:[BufferModeBox class]]) {
    ...
    [self writeByte:136];
    [self writeValue:[value toList]];
  } else if ([value isKindOfClass:[SetUrlArgs class]]) {
    [self writeByte:137];
    [self writeValue:[value toList]];
...
@interface QueueManagerPigeon ()
@property(nonatomic, strong) NSObject<FlutterBinaryMessenger> *binaryMessenger;
@property(nonatomic, strong) NSString *messageChannelSuffix;
@end

@implementation QueueManagerPigeon
...
- (void)handlePlaybackEnded:(NSString *)arg_playerId mediaItem:(nullable MediaItem *)arg_current completion:(void (^)(FlutterError *_Nullable))completion {
  NSString *channelName = [NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.bccm_player.QueueManagerPigeon.handlePlaybackEnded", _messageChannelSuffix];
  FlutterBasicMessageChannel *channel =
    [FlutterBasicMessageChannel
      messageChannelWithName:channelName
      binaryMessenger:self.binaryMessenger
      codec:nullGetPlaybackPlatformApiCodec()];
  [channel sendMessage:@[arg_playerId ?: [NSNull null], arg_current ?: [NSNull null]] reply:^(NSArray<id> *reply) {
    if (reply != nil) {
      if (reply.count > 1) {
...
- (void)skipToNext:(NSString *)arg_playerId completion:(void (^)(FlutterError *_Nullable))completion {
  NSString *channelName = [NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.bccm_player.QueueManagerPigeon.skipToNext", _messageChannelSuffix];
  FlutterBasicMessageChannel *channel =
    [FlutterBasicMessageChannel
      messageChannelWithName:channelName
      binaryMessenger:self.binaryMessenger
      codec:nullGetPlaybackPlatformApiCodec()];
  [channel sendMessage:@[arg_playerId ?: [NSNull null]] reply:^(NSArray<id> *reply) {
    if (reply != nil) {
      if (reply.count > 1) {
        completion([FlutterError errorWithCode:reply[0] message:reply[1] details:reply[2]]);
      } else {
...
- (void)skipToPrevious:(NSString *)arg_playerId completion:(void (^)(FlutterError *_Nullable))completion {
  NSString *channelName = [NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.bccm_player.QueueManagerPigeon.skipToPrevious", _messageChannelSuffix];
  FlutterBasicMessageChannel *channel =
    [FlutterBasicMessageChannel
      messageChannelWithName:channelName
      binaryMessenger:self.binaryMessenger
